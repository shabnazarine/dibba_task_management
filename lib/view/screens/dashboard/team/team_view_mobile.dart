...
class TeamViewMobile extends StatefulWidget {
  const TeamViewMobile({super.key});

  @override
  State<TeamViewMobile> createState() => _TeamViewMobileState();
}

class _TeamViewMobileState extends State<TeamViewMobile> {
  @override
