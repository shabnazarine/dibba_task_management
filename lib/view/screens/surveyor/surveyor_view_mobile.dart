...
import '../../widget/surveyor_task_card.dart';
import 'package:intl/intl.dart';

class SurveyorViewMobile extends StatefulWidget {
  const SurveyorViewMobile({super.key});

  @override
  State<SurveyorViewMobile> createState() => _SurveyorViewMobileState();
}

class _SurveyorViewMobileState extends State<SurveyorViewMobile> {
  @override
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index){
                            return Padding(
                              ...
                              child: SurveyorTaskCard(applicationNumber: 'Application Number',taskType: 'Complaint Report', taskStatus: 'Review', ),
                            );
                          }, ),
                      ),
                      SizedBox(height: 20,),
