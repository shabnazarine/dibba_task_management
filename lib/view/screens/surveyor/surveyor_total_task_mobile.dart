...
class SurveyorTotalTaskMobile extends StatefulWidget {
  const SurveyorTotalTaskMobile({super.key});

  @override
  State<SurveyorTotalTaskMobile> createState() => _SurveyorTotalTaskMobileState();
}

class _SurveyorTotalTaskMobileState extends State<SurveyorTotalTaskMobile> {
