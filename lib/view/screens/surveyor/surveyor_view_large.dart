...
class SurveyorViewLarge extends StatefulWidget {
  const SurveyorViewLarge({super.key});

  @override
  State<SurveyorViewLarge> createState() => _SurveyorViewLarge();
}

class _SurveyorViewLarge extends State<SurveyorViewLarge> {
  @override
