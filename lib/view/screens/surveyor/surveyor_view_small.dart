...
class SurveyorViewSmall extends StatefulWidget {
  const SurveyorViewSmall({super.key});

  @override
  State<SurveyorViewSmall> createState() => _SurveyorViewSmallState();
}

class _SurveyorViewSmallState extends State<SurveyorViewSmall> {
  @override
