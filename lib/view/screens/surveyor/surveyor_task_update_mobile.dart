...
class SurveyorUpdateTaskMobile extends StatefulWidget {
  const SurveyorUpdateTaskMobile({super.key});

  @override
  State<SurveyorUpdateTaskMobile> createState() => _SurveyorUpdateTaskMobileState();
}

class _SurveyorUpdateTaskMobileState extends State<SurveyorUpdateTaskMobile> {
  @override
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding:  EdgeInsets.only(left: 60, top: 30, right: 50),
                              child: TextFormField(
                                enabled: false,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.only(left: 70, top: 20, right: 50),
                              child: TextFormField(
                                enabled: false,
                                decoration: InputDecoration(
                                  focusedBorder: UnderlineInputBorder(
