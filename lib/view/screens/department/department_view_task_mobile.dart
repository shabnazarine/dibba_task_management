...
class DepartmentViewTaskMobile extends StatefulWidget {
  const DepartmentViewTaskMobile({super.key});

  @override
  State<DepartmentViewTaskMobile> createState() => _DepartmentViewTaskMobileState();
}

class _DepartmentViewTaskMobileState extends State<DepartmentViewTaskMobile> {
  @override
