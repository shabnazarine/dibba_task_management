...
import 'department_create_task_mobile.dart';

class DepartmentViewMobile extends StatefulWidget {
  const DepartmentViewMobile({super.key});

  @override
  State<DepartmentViewMobile> createState() => _DepartmentViewMobileState();
}

class _DepartmentViewMobileState extends State<DepartmentViewMobile> {
  @override
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: (){
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => const DepartmentCreateTaskMobile()),
                                        );
                                      },
                                      child: Text(
                                        "New Task (Internal)",
