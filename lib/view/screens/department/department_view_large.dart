...
class DepartmentViewLarge extends StatefulWidget {
  const DepartmentViewLarge({super.key});

  @override
  State<DepartmentViewLarge> createState() => _DepartmentViewLargeState();
}

class _DepartmentViewLargeState extends State<DepartmentViewLarge> {
  @override
