...
import 'package:dibba_task_management/view/widget/dropdown_application_type_mobile.dart';
import 'package:dibba_task_management/view/widget/dropdown_location_mobile.dart';
import 'package:dibba_task_management/view/widget/dropdown_surveyors.dart';
import 'package:flutter/material.dart';

import '../../widget/dropdown_status.dart';

class DepartmentCreateTaskMobile extends StatefulWidget {
  const DepartmentCreateTaskMobile({super.key});

  @override
  State<DepartmentCreateTaskMobile> createState() => _DepartmentCreateTaskMobile();
}

class _DepartmentCreateTaskMobile extends State<DepartmentCreateTaskMobile> {
  @override
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding:  EdgeInsets.only(left: 40, top: 30, right: 50),
                              child: TextFormField(
                                autocorrect: false,
                                style: TextStyle(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.only(left: 50, top: 30, right: 10),
                              child: TextFormField(
                                autocorrect: false,
                                style: TextStyle(
                                  color: Colors.white.withOpacity(.50),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.only(left: 25, top: 40, right: 50),
