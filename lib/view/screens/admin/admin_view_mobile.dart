...
import 'create_new_user_mobile.dart';

class AdminViewMobile extends StatefulWidget {
  const AdminViewMobile({super.key});

  @override
  State<AdminViewMobile> createState() => _AdminViewMobileState();
}

class _AdminViewMobileState extends State<AdminViewMobile> {
  @override
                  ...
                  Container(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const CreateNewUserMobile()),
                        );
                      },
