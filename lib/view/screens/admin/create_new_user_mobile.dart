...
class CreateNewUserMobile extends StatefulWidget {
  const CreateNewUserMobile({super.key});

  @override
  State<CreateNewUserMobile> createState() => _CreateNewUserMobile();
}

class _CreateNewUserMobile extends State<CreateNewUserMobile> {
  @override
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.only(left: 50, top: 40, right: 60),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              padding: const EdgeInsets.only(left: 100, top: 30, right: 60),
                              child: TextFormField(
                                style: TextStyle(
