...
import 'counter_create_task_mobile.dart';
import 'package:intl/intl.dart';

class CounterViewMobile extends StatefulWidget {
  const CounterViewMobile({super.key});

  @override
  State<CounterViewMobile> createState() => _CounterViewMobileState();
}

class _CounterViewMobileState extends State<CounterViewMobile> {
  @override
                          ...
                          children: [
                            GestureDetector(
                              onTap: (){
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => const CounterCreateTaskMobile()),
                                );
                              },
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.start,
