...
import '../screens/department/department_update_task.dart';
import '../screens/department/department_view_task.dart';

class DepartmentTaskCard extends StatelessWidget {

  const DepartmentTaskCard({required this.applicationNumber, this.onTap, required this.taskType, required this.taskStatus, required this.person});
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: (){
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => const DepartmentUpdateTask()),
                                );
                              },
                              child: Icon(
                                Icons.edit,
