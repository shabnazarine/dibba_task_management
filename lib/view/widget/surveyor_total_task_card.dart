...
class SurveyorTotalTaskCard extends StatelessWidget {

  const SurveyorTotalTaskCard({required this.applicationNumber, this.onTap, required this.taskType, required this.taskStatus});
