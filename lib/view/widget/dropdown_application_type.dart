...
class ApplicationTypeDropDown extends StatefulWidget {
  const ApplicationTypeDropDown({super.key});

  @override
  State<ApplicationTypeDropDown> createState() => _ApplicationTypeDropDownState();
}

class _ApplicationTypeDropDownState extends State<ApplicationTypeDropDown> {
