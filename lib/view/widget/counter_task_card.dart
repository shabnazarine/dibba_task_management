...
class CounterTaskCard extends StatelessWidget {

  const CounterTaskCard({required this.applicationNumber, this.onTap, required this.taskType, required this.taskStatus});
